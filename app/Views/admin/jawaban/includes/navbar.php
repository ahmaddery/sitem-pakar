...
<!-- Nav Item -Users -->
<li class="nav-item active">
  <a class="nav-link" href="<?= base_url('admin/users/index') ?>">
    <i class="fas fa-fw fa-tachometer-alt"></i>
    <span>Managemen Pengguna</span></a>
</li>
...
<li class="nav-item">
  <a class="nav-link" href="<?= base_url('admin/aturan') ?>">
    <i class="fas fa-fw fa-chart-area"></i>
    <span>Aturan</span></a>
</li>

<li class="nav-item">
  <a class="nav-link" href="<?= base_url('admin/pertanyaan/index') ?>">
    <i class="fas fa-fw fa-chart-area"></i>
